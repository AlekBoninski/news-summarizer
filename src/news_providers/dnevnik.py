...
class DnevnikCrawler:
    ...
    def __fetch_latest_article_links_and_titles(self, articles_to_fetch=1):
    ...
    def fetch_articles(self, articles_to_fetch=1):
    ...
    def test(self):
        ...
        article = self.__fetch_article(article_link)
        print(article)
